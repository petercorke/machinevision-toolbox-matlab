%SAD	Stereo matching using Sum of Absolute Differences metric
%
%	[DISP SCORES] = SAD(LEFT, RIGHT, LEFT_RIGHT, WIN_SIZE, DISP_RANGE)
%
%       DISP = Disparity map
%       SCORES = SAD scores at each disparity
%       LEFT, RIGHT = images
