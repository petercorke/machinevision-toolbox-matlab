...
void match_SSD_right (unsigned char *left_image, unsigned char *right_image, signed char *disparity, double *scores, int width, int height, int x_window_size, int y_window_size, int min_disparity, int max_disparity) {
...
void match_SSD_left (unsigned char *left_image, unsigned char *right_image, signed char *disparity, double *scores, int width, int height, int x_window_size, int y_window_size, int min_disparity, int max_disparity) {
...
#define MATCH_RIGHT     match_SSD_right
#define	MATCH_LEFT	match_SSD_left
